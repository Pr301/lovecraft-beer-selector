	...
	{#key step}
		...
		>
			...
			{:else if step === 1}
				...
				<QuestionLayout onback={() => goTo(0, -1)} backLabel={t.back} {locale} onlocale={(l) => (locale = l)}>
			...
			{:else if step === 2}
				...
				<QuestionLayout onback={() => goTo(1, -1)} backLabel={t.back} {locale} onlocale={(l) => (locale = l)}>
					<div class="w-full max-w-xl mx-auto flex flex-col gap-4">
						<h2
							class="font-fredoka font-black text-brand-pink text-center shrink-0"
							style="font-size: clamp(1.8rem, 8vw, 2.8rem)"
			...
			{:else if step === 3}
				<!-- Q2: Beer color -->
				<QuestionLayout onback={() => goTo(2, -1)} backLabel={t.back} {locale} onlocale={(l) => (locale = l)}>
			...
			{:else if step === 4}
				<!-- Q3: ABV strength -->
				<QuestionLayout onback={() => goTo(3, -1)} backLabel={t.back} {locale} onlocale={(l) => (locale = l)}>
			...
			{:else if step === 5}
				<!-- Q4: Country -->
				<QuestionLayout onback={() => goTo(mode === 'country' ? 1 : 4, -1)} backLabel={t.back} {locale} onlocale={(l) => (locale = l)}>
					<div class="w-full max-w-xl mx-auto flex flex-col gap-6">
						<h2
							class="font-fredoka font-black text-brand-pink text-center shrink-0"
							style="font-size: clamp(1.8rem, 8vw, 2.8rem)"
			...
			{:else if step === 8}
				...
				<QuestionLayout onback={() => goTo(7, -1)} backLabel={t.back} {locale} onlocale={(l) => (locale = l)}>
